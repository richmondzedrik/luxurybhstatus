          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <div className="flex-1 relative">
              ...
              <input
                ...
                className="block w-full pl-10 pr-12 py-2 border border-gray-300 rounded-lg shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200"
              />
              {searchTerm && (
                <button
          ...
          {users.length > 0 && (
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              ...
              <div className="bg-red-100 border border-red-200 rounded-lg p-3 text-center">
                <div className="text-lg font-bold text-red-700">{stats.afk}</div>
                <div className="text-xs text-red-600">🔴 AFK</div>
              </div>
              <div className="bg-blue-100 border border-blue-200 rounded-lg p-3 text-center">
                <div className="text-lg font-bold text-blue-700">{Object.keys(stats.classCounts).length}</div>
                <div className="text-xs text-blue-600">⚔️ Classes</div>
              </div>
          ...
          <div className="text-center py-12">
            {searchTerm ? (
              <>
                ...
                <p className="text-gray-500 text-lg mb-2">No hunters found</p>
                <p className="text-gray-400 text-sm">Try adjusting your search terms</p>
                <button
                  onClick={() => setSearchTerm('')}
                  className="mt-4 bg-blue-100 hover:bg-blue-200 text-blue-700 px-4 py-2 rounded-lg text-sm font-medium transition-colors"
                >
                  Clear Search
                </button>
              </>
